...
<nav class="navbar fixed-top d-flex flex-row">
    <div class="navbar-menu-container d-flex align-items-center justify-content-center">
        <div class="text-center navbar-brand-container align-items-center justify-content-center">
            <a class="brand-logo" href="{{ route('dashboard.index') }}"><img src="{{ asset('img/dash/logo-brand-small.png') }}" alt="Scalar Dashboard" title="Scalar Dashboard" /></a>
        </div>
        <div class="sub-header">
            <h4 class="page-title text-center"><a href="{{ route('dashboard.index') }}">Dashboard</a></h4>
        </div>
